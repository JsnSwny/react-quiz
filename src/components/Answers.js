...
const Answers = ({ answers, questions, tryAgain }) => {
    ...
    return (
        <div className="text-center w-full">     
            ...
            <div className="bg-gray-200 p-4 mt-4 mx-auto w-11/12 md:w-3/4 shadow-md">
                ...
                <div className="md:flex md:flex-wrap md:justify-center mt-4">
                {
                    answerValues.map((answer,index) => {
                        ...
                        return (
                            <div key={index} className="md:w-1/2 lg:w-1/3 xl:w-1/4 my-2"> 
                                <h1 className="font-bold text-xl ">Question {index+1}</h1>
                                {
                                    (actualAnswer === answer) 
                                    ? <h2 className="text-green-600"><strong>Correct!</strong> You answered: "{ answer }"</h2> 
                                    : <h2 className="text-red-600"><strong>Wrong!</strong> You answered: "{ answer }" <br/> <span className="text-xs">(Correct Answer: "{ actualAnswer }")</span></h2>
                                }
                            </div>
                        )           
                    })   
            ...
            <button className="bg-orange-500 focus:outline-none hover:bg-orange-400 text-white mx-2 mt-8 py-3 px-10 font-bold rounded" onClick={ tryAgain }>Try Again</button>
        </div>
    )
}
